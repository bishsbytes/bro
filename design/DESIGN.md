...
Native implementation and the component mapping are in [REACT_NATIVE.md](REACT_NATIVE.md). The original Helm package is retained below as historical context; conflicting visual instructions and its PR checklist no longer govern new work.
