# Archived — the Helm rulebook

Superseded by Grounded Editorial in September 2026. Kept for rationale only;
nothing here governs new work. The current rules are in `design/DESIGN.md`.
