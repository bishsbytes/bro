# Archived — the Helm design package

Superseded by Grounded Editorial in September 2026. The paths below describe
this archive directory, not the live `design/` folder. Instrument Sans,
Instrument Serif and Geist Mono are retired, as is the user-selectable OKLCH
accent. `brand/` stayed in `design/` because it still generates the app icons.
