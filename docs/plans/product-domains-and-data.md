...
6. **Habits and challenges.** Self-contained, tagged to the step 3 area vocabulary, and the first thing that gives a user a reason to open the app on a day they feel fine. Detailed delivery plan: [Step 6: Habits and challenges](step-6-habits-and-challenges.md).
