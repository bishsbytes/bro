...
/**
 * Opens this device's local product database once per process.
...
export async function initDb(
	...
	// caller asking for a different file is rejected instead of being handed the
	// first caller's handle.
...
/** Closes the active handle so startup can retry. */
